...
void push_to_queue(binary_tree_t *node, levelorder_queue_t *head,
...
/**
 * push_to_queue - Runs a function on a given binary tree node and
...
/**
 * binary_tree_levelorder - traverses a binary tree by level-order traversal.
 *
